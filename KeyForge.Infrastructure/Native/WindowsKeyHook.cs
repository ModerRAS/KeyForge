...
namespace KeyForge.Infrastructure.Native
{
    ...
    public class WindowsKeyHook : IKeyHook
    {
        ...
        public event EventHandler<string>? HookError;
        ...
        private IntPtr HookCallback(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            catch (Exception ex)
            {
                ...
                var errorMessage = $"键盘钩子回调发生错误: {ex.Message}";
                Console.WriteLine(errorMessage);
                HookError?.Invoke(this, errorMessage);
                return CallNextHookEx(_hookHandle, nCode, wParam, lParam);
            }
        }

        private bool ShouldFilterKey(System.Windows.Forms.Keys key)
        {
            // 过滤掉一些可能引起问题的按键
