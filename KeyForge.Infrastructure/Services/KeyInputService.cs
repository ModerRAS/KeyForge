...
namespace KeyForge.Infrastructure.Services
{
    ...
    public class KeyInputService : IDisposable
    {
        ...
        public KeyInputService()
        {
            ...
            _keyHook.HookError += OnHookError;
        }
        ...
        public void SimulateKey(System.Windows.Forms.Keys key, bool isKeyDown)
        {
            try
            {
                if (isKeyDown)
        ...
        public void SimulateKeySequence(System.Collections.Generic.IEnumerable<(System.Windows.Forms.Keys Key, bool IsKeyDown)> keySequence)
        {
        ...
        private void OnHookError(object sender, string errorMessage)
        {
            OnStatusChanged($"钩子错误: {errorMessage}");
        }
