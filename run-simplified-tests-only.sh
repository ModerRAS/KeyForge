...
# 项目路径
PROJECT_PATH="KeyForge.Tests.Simplified/KeyForge.Tests.Simplified.csproj"
TEST_RESULTS_DIR="TestResults-Simplified"
...
generate_coverage_report() {
    ...
    # 生成HTML报告
    reportgenerator -reports:"$coverage_file" -targetdir:"$TEST_RESULTS_DIR/coverage" -reporttypes:Html
    
    print_message $GREEN "覆盖率报告生成完成: $TEST_RESULTS_DIR/coverage/index.html"
}
...
<body>
    ...
    <div class="section">
        <h2>覆盖率报告</h2>
        <p>如果生成了覆盖率报告，请查看: $TEST_RESULTS_DIR/coverage/index.html</p>
    </div>
</body>
</html>
EOF
...
main() {
    ...
    if [ -f "$TEST_RESULTS_DIR/coverage/index.html" ]; then
        print_message $BLUE "覆盖率报告: $TEST_RESULTS_DIR/coverage/index.html"
    fi
}
